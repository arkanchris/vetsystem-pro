...
router.delete('/admins/:id',            verificarToken, soloMaster, deleteAdmin);           // desactivar
router.delete('/admins/:id/eliminar',  verificarToken, soloMaster, deleteAdminDefinitivo);  // eliminar definitivo
